...
var items []item = []item{
	{ID: 1, Item: "banana", Price: 0.49},
	{ID: 2, Item: "popcorn with herbs", Price: 3.49},
	{ID: 3, Item: "peeled tomatoes", Price: 2.49},
	{ID: 4, Item: "tomato paste", Price: 1.99},
}
...
var rus []ru = []ru{
	...
	{ReceiptID: 1, UserID: 2},
	{ReceiptID: 2, UserID: 2},
}
